...
(
    ...
    CONSTRAINT pk_cadastra_evento PRIMARY KEY (evento_id)
);
...
(
    ...
    CONSTRAINT pk_solicitaservico PRIMARY KEY (servico_id)
);
...
ALTER TABLE cadastra_evento
    ADD CONSTRAINT FK_CADASTRA_EVENTO_ON_EVENTO FOREIGN KEY (evento_id) REFERENCES evento (id);

ALTER TABLE cadastra_evento
    ADD CONSTRAINT FK_CADASTRA_EVENTO_ON_HOSPEDE FOREIGN KEY (hospede_id) REFERENCES usuario (id);
